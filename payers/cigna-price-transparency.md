...
| ----------------------------- | ------------ |
| Providers                     | 51,679,565 |
| Rates                         | 11,736,764,997 |
| Nonstandard Codes             | 3,278,914 |
| Bundled Codes                 | 0 |
...
* **File Accessibility Percentage:** :yellow\_circle: 100% of the files are accessible.

**Overall Assessment:** Cigna uploads contracted rates at the individual NPI level, when they should be at organizational NPI level. This causes unnecessary complexity and requires manual intervention to use their data. We are monitoring this for improvements.

...
Humana has by far the most voluminous data, and we believe they will soon be forced to change their practices, but for now we parse out nearly 12 million files to get to trillions of rows of data.

### Schema: HUMANA

### Table 1: PROVIDER\_MAP - 1.8T Records
...
### Table 2: NEGOTIATED\_RATES - 891B Records
...
### Table 3: BILLING\_CODES - 37.1M Records
